...
export interface UserProfile {
  ...
  full_name: string;
  email: string;
  // Aceita também o valor livre de funcionarios.cargo (ex: 'Vendedor(a)', 'Gerente')
  // desde a Fase A do item 6, quando funcionário passou a ter perfil próprio.
  role: 'master' | 'optometrista' | 'atendente' | 'caixa' | 'system_admin' | string;
  active: boolean;
  crm?: string;
  specialty?: string;
  avatar_url?: string;
