...
import RelatoriosConsultas from './RelatoriosConsultas';
import FinanceiroConsultas from './FinanceiroConsultas';
import FilaEsperaConsultas from './FilaEsperaConsultas';
...
export default function ConsultaPage() {
  ...
  return (
    <div>
      ...
      {/* Fila de Espera (visão do dia, separada da grade semanal da Agenda) */}
      {tab === 'fila' && <FilaEsperaConsultas/>}

      {/* Financeiro (Contas a Receber/Pagar do módulo) */}
      {tab === 'financeiro' && <FinanceiroConsultas/>}

      {/* Relatórios (Fase 7) */}
      {tab === 'relatorios' && <RelatoriosConsultas/>}

      {/* Ações (relatórios operacionais com atalho de WhatsApp: Aniversariantes, Consultas Vencidas, Inadimplentes) */}
      {tab === 'acoes' && <RelatoriosOperacionais/>}
